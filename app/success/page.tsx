          ...
          <Box className="w-full flex my-auto   h-[80vh]   p-4 items-center justify-center lg:py-10 ">
            <Box className="w-full md:max-w-[664px] bg-[whitesmoke] p-[20px] md:p-[45px] rounded-md">
              ...
              <Box className="flex flex-col justify-center items-center w-full h-full my-6">
                <Text
                  c={"#171717"}
                  className="text-center text-[12px] md:text-[15px]  lg:text-[17px] font-poppins-regular text-text_label    md:w-full "
                >
                  Your reservation has been made.
                </Text>
                <Text
                  c={"#171717"}
                  className="text-[12px] md:text-[15px] mt-4  lg:text-[17px] font-poppins-regular text-text_label   md:w-full  text-center"
                >
              ...
              <div className=" flex justify-center w-full">
                <Link href={"/"} className="">
                  <Button
                    ...
                    type="submit"
                    variant="white"
                    className="bg-[#ed7301] font-poppins-semibold text-lg capitalize text-white rounded-lg w-full md:max-w-[50%]"
                  >
                    Okay
                  </Button>
                </Link>
