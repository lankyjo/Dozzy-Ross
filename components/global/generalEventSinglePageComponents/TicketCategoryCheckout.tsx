...
function TicketCategoryCheckout({
  ...
  return (
    <>
      ...
      <Stack className="relative  md:mt-[32px]  justify-start">
        <Text
          fw={"bolder"}
          c="#171717"
        ...
        <Box className=" flex justify-center items-center gap-1 flex-row mr-auto mt-[-10px]">
          ...
          <Text
            c="#171717"
            className="text-[14px] md:text-[15px]  lg:text-[17px] font-poppins-regular text-text_label ">
            {formattedDuration}
          </Text>
        </Box>
      </Stack>
      ...
      <Box
        bg={"#171717"}
        className="w-full bottom-0 bg-primary_color_70 z-10 flex flex-col py-4 border-solid border-[.5px]  border-[#567aa7] p-[7px] justify-around items-center fixed left-0">
        <Box>
