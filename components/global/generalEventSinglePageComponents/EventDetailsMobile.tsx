      ...
      <Box
        ...
        <>
          <Text
            fw={"bolder"}
            c={"#171717"}
            className="text-center text-[17px]   md:text-[24px] font-poppins-semibold text-primary_color_70">
            {event?.event_title || unavailable}
          </Text>

          <Group className="relative flex flex-col  justify-start my-1">
            <Box className="  capitalize px-2 rounded-md  bg-orange-200    p-1   flex justify-center items-center gap-1 flex-row  mt-[-10px]">
              <Text
                c={"#171717"}
                className="  text-[12px] md:text-[15px]  lg:text-[17px] font-poppins-regular text-text_label ">
          ...
          <Box
            ...
            <Text className="flex justify-center mr-1 items-center text-[13px] md:text-[15px]  lg:text-[17px] font-poppins-medium">
              <PersonIcon />
            </Text>
            <Text
              c={"#171717"}
              className="flex items-center gap-1 text-[13px] md:text-[15px] lg:text-[17px] font-poppins-regular ">
              Organizer:{" "}
          ...
          <Box className="text-center flex  w-full justify-center  items-start gap-1  my-1 ">
            ...
            <Text
              c={"#171717"}
              className="text-center text-[12px] md:text-[15px]  lg:text-[17px] font-poppins-regular text-text_label capitalize  ">
